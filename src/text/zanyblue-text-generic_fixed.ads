...
package ZanyBlue.Text.Generic_Fixed is
   ...
   type Fixed_Argument is new Argument_Type with private;

   function Create (Fixed_Value : Fixed_Type) return Fixed_Argument;
   --  Create a "boxed" instance of fixed value.

   function "+" (Fixed_Value : Fixed_Type) return Fixed_Argument
      renames Create;
...
private
   ...
   type Fixed_Argument is new Argument_Type with record
      Data : Fixed_Type;
   end record;
