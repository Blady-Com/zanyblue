...
package ZanyBlue.Text.Strings is
   ...
   type String_Argument (<>) is new Argument_Type with private;

   function Create (Value : String) return String_Argument;
   --  Create a "boxed" instance of a string type.

   function "+" (Value : String) return String_Argument
      renames Create;
   --  Utility renaming of the "Create" function.

   overriding
   function Format (Value    : String_Argument;
...
private
   ...
   type String_Argument (Length : Natural) is new Argument_Type with record
