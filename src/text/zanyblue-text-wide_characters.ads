...
package ZanyBlue.Text.Wide_Characters is
   ...
   type Wide_Character_Argument is new Argument_Type with private;

   function Create (Wide_Character_Value : Wide_Character)
      return Wide_Character_Argument;
...
private
   ...
   type Wide_Character_Argument is new Argument_Type with record
      Data : Wide_Character;
   end record;
