...
package ZanyBlue.Text.Generic_Integers is
   ...
   type Integer_Argument is new Argument_Type with private;

   function Create (Value : Integer_Type) return Integer_Argument;
   --  Create a "boxed" instances of an integer value.

   function "+" (Value : Integer_Type) return Integer_Argument
      renames Create;
