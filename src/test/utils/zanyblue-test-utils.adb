...
package body ZanyBlue.Test.Utils is
   ...
   begin
      Add_Routine (T, T_0001'Access, "T_0001, Banner function");
      Add_Routine (T, T_0002'Access, "T_0002, Banner procedure");
      Add_Routine (T, T_0003'Access, "T_0003, Trailer procedure");
   end Register_Tests;
