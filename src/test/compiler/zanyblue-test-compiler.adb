...
package body ZanyBlue.Test.Compiler is
   ...
   begin
      return Format ("ZanyBlue.Compiler");
   end Name;

   overriding
   procedure Register_Tests (T : in out Test_Case) is
   begin
      Add_Routine (T, T_0001'Access, "T_0001, Compiler name");
      Add_Routine (T, T_0002'Access, "T_0002, Wide_Create procedure");
      Add_Routine (T, T_0003'Access, "T_0003, Spec_File_Name function");
      Add_Routine (T, T_0004'Access, "T_0004, Body_File_Name function");
      Add_Routine (T, T_0005'Access, "T_0005, To_UTF8 ('')");
      Add_Routine (T, T_0006'Access, "T_0006, From_UTF8 ('')");
   end Register_Tests;
