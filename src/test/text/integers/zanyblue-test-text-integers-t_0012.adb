...
begin
   Check_Value (R, Arg0.Format ("o", Locale), "0");
   Check_Value (R, Arg1.Format ("o", Locale), "3731");
   Check_Value (R, Arg2.Format ("o", Locale), "-3731");
   Check_Value (R, Arg3.Format ("o", Locale), "17777777777");
   Check_Value (R, Arg4.Format ("o", Locale), "-17777777777");
end T_0012;
