...
begin
   Check_Value (R, Arg0.Format ("#X", Locale), "16#0#");
   Check_Value (R, Arg1.Format ("#X", Locale), "16#7D9#");
   Check_Value (R, Arg2.Format ("#X", Locale), "-16#7D9#");
   Check_Value (R, Arg3.Format ("#X", Locale), "16#7FFFFFFF#");
   Check_Value (R, Arg4.Format ("#X", Locale), "-16#7FFFFFFF#");
end T_0020;
