...
begin
   Check_Value (R, Arg0.Format ("#b", Locale), "2#0#");
   Check_Value (R, Arg1.Format ("#b", Locale), "2#11111011001#");
   Check_Value (R, Arg2.Format ("#b", Locale), "-2#11111011001#");
   Check_Value (R, Arg3.Format ("#b", Locale),
                "2#1111111111111111111111111111111#");
   Check_Value (R, Arg4.Format ("#b", Locale),
                "-2#1111111111111111111111111111111#");
end T_0017;
