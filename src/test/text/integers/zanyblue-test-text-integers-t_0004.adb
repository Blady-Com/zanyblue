...
begin
   Check_Value (R, Arg0.Format ("*=10d", Locale), "*********0");
   Check_Value (R, Arg0.Format ("0=10d", Locale), "0000000000");
   Check_Value (R, Arg1.Format ("*=10d", Locale), "******2009");
   Check_Value (R, Arg1.Format ("0=10d", Locale), "0000002009");
   Check_Value (R, Arg2.Format ("*=10d", Locale), "-*****2009");
   Check_Value (R, Arg2.Format ("0=10d", Locale), "-000002009");
end T_0004;
