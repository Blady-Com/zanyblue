...
procedure T_0055 (R : in out AUnit.Test_Cases.Test_Case'Class) is
   ...
   procedure Check (Format : Wide_String;
      ...
      Arg1      : constant Time_Argument := Create (V1, 4 * 60);
...
begin
   ...
   Check ("full",   "16:48:03 +0400 четверг, 16 июня 1904 г.");
   Check ("long",   "16:48:03 +0400 16 июня 1904 г.");
   Check ("medium", "16:48:03 16.06.1904");
