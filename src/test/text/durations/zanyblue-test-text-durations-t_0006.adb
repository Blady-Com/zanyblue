...
begin
   ...
   Append (List, +V3);
   Append (List, +V4);
   Check_Value (R, List.Format (0, "", Locale, False), "0:00:00.000");
   Check_Value (R, List.Format (1, "", Locale, False), "0:01:01.000");
   Check_Value (R, List.Format (2, "", Locale, False), "1:01:01.000");
   Check_Value (R, List.Format (3, "", Locale, False), "1 1:01:01.000");
end T_0006;
