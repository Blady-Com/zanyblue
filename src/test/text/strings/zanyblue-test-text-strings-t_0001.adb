...
procedure T_0001 (R : in out AUnit.Test_Cases.Test_Case'Class) is
   ...
   Arg1      : constant String_Argument := Create (V1);
   Arg2      : constant String_Argument := Create (V2);
   Arg3      : constant String_Argument := Create (V3);
   Arg4      : constant String_Argument := Create (V4);
